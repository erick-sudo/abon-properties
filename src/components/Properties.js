    ...
    return (
        <div>
            <div className="flex flex-col px-3 pb-12 bg-black/80 text-white font-bold">
                ...
                <div className="grow flex justify-center items-center text-sky-400"><span className="text-2xl flex items-center"><MdOutlineArrowBackIosNew />======</span><TiStarburst className="text-8xl animate-spin" /><span className="text-2xl flex items-center">======<MdOutlineArrowForwardIos /></span></div>
            </div>
